...
2.  厌倦了千篇一律的“AI网红脸”图片？Black Forest Labs与Krea AI联手发布了一款“有主见”的开源图像模型**FLUX.1 Krea [dev]**，专治过度饱和与AI味儿！这款模型自带审美，生成的图像细节丰富、风格独特，就像一位有经验的插画师，总能给你意想不到的惊喜🎨。感兴趣的开发者可以[通过HuggingFace免费获取 - （AI资讯）](https://huggingface.co/black-forest-labs/FLUX.1-Krea-dev)，或通过 [（AI资讯）：FAL](https://fal.ai)、[Replicate - （AI资讯）](https://replicate.com)、[Runware](https://runware.com)、[（AI资讯）：DataCrunch](https://datacrunch.io) 和 [TogetherAI - （AI资讯）](https://together.ai) 等平台接入API，也可以在[（AI资讯）：官方介绍](https://www.xiaohu.ai/c/a066c4/flux-1-krea-dev-ai-ai)中查看更多信息，或参考[详细教程 - （AI资讯）](https://docs.comfy.org/tutorials/flux/flux1-krea-dev)在ComfyUI中使用。
